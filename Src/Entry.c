...
int more_function( NO_SEGMENT no, void *p1, void *p2 )
{
    ...
    do
    {
        switch(ManageMenu(appName, 0, 0, NUMBER_OF_ITEMS(MenuUser), MenuUser,0))
        {
...
/*
    ...
    ttestall(PRINTER,500);                              // Print volume+file_name
...
void entry(void)
{
  ...
  memcpy(appName,"MOBILE", OBJECT_NAME_LEN);
  memcpy(fileName, "MOBILE", OBJECT_FILE_NAME_LEN);
